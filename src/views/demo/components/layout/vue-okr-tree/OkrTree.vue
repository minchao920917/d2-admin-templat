<template>
  <div class="org-chart-container">
    <div
      ...
      :class="{
        'vertical-wrap': direction === 'vertical',
...
.vertical-wrap .org-chart-node-children {
  position: relative;
  padding-top: 20px;
  /* transition: all 0.5s; */
}
.vertical-wrap .org-chart-node {
  float: left;
  text-align: center;
...
.vertical-wrap .org-chart-node::before,
.vertical-wrap .org-chart-node::after {
  content: "";
  position: absolute;
  top: 0;
  right: 50%;
...
.vertical-wrap.one-branch > .org-chart-node::after,
.vertical-wrap.one-branch > .org-chart-node::before {
  display: none;
}
/*从单个子节点的顶部移除空格*/
.vertical-wrap.one-branch > .org-chart-node {
  padding-top: 0;
}
/*从第一个子节点移除左连接器，从最后一个子节点移除右连接器*/
.vertical-wrap .org-chart-node:first-child::before,
.vertical-wrap .org-chart-node:last-child::after {
  border: 0 none;
}
/*将垂直连接器添加回最后的节点*/
.vertical-wrap .org-chart-node:last-child::before {
  border-right: 1px solid #ccc;
  border-radius: 0 5px 0 0;
}
.vertical-wrap .org-chart-node:only-child:before {
  border-radius: 0 0px 0 0;
  margin-right: -1px;
}
.vertical-wrap .org-chart-node:first-child::after {
  border-radius: 5px 0 0 0;
}
.vertical-wrap .org-chart-node.is-leaf {
  padding-top: 20px;
  padding-bottom: 20px;
}
.vertical-wrap .org-chart-node.is-leaf::before {
  content: "";
  display: block;
  height: 20px;
}
.vertical-wrap .org-chart-node.is-leaf .org-chart-node-label::after {
  display: none;
}

/*从父节点添加向下的连接器了*/
.vertical-wrap .org-chart-node-children::before {
  content: "";
  position: absolute;
  top: 0;
  left: 50%;
...
.vertical-wrap .org-chart-node-label {
  position: relative;
  display: inline-block;
}
.vertical-wrap .org-chart-node-label .org-chart-node-label-inner {
...
.vertical-wrap .org-chart-node-label .org-chart-node-label-inner:hover {
  box-shadow: 0 1px 14px rgba(31, 35, 41, 0.12);
  cursor: pointer;
}
.vertical-wrap .org-chart-node-label .org-chart-node-btn {
  position: absolute;
  top: 100%;
  left: 50%;
  width: 20px;
...
.vertical-wrap .org-chart-node-label .org-chart-node-btn:hover {
  transform: scale(1.15);
  cursor: pointer;
}
.vertical-wrap .org-chart-node-label .org-chart-node-btn::before,
.vertical-wrap .org-chart-node-label .org-chart-node-btn::after {
  content: "";
  position: absolute;
}
.vertical-wrap .org-chart-node-label .org-chart-node-btn::before {
...
.vertical-wrap .org-chart-node-label .expanded.org-chart-node-btn::after {
  display: none;
}

.vertical-wrap .org-chart-node.collapsed .org-chart-node-label {
  position: relative;
}
.vertical-wrap .org-chart-node.collapsed .org-chart-node-label::after {
  content: "";
  position: absolute;
  top: 100%;
  left: 0;
