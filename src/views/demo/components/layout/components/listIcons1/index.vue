 ...
 * @LastEditors: minchao
 * @LastEditTime: 2024-05-23 22:43:54
 * @Description: 请填写简介
-->
...
<div class="list-wrap" style="width: 100%">
    <div class="list-item list-header">
       <span class="left"> 工序名称</span>
        <span  class="middle">开始时间</span>
  ...
  <div class="infinite-list-wrapper" style="overflow:auto">
    ...
    <ul
      ...
      <li v-for="(index,i) in count" class="list-item" :key="index">
        ...
        <el-link  class="right">查看<i class="el-icon-view el-icon--right"></i> </el-link>
      </li>
    </ul>
